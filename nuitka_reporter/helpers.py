...
def has_nuitka_version_upgraded_report(nuitaka_version: Version):
    """
    Returns True if the report is generated by Nuitka version >= 4.1.0-rc.7, which includes the new object file size information and c code generation times. Otherwise, returns False.
    """
