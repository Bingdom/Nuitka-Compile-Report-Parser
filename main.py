...
size_graph = size.get_plotter(FILE)
time_graph = time.get_plotter(FILE)
dep_fig, dep_graph = dependency_from_report.get_fig(FILE)
...
app.layout = html.Div([
    ...
    dcc.Graph(figure=size_graph.fig, id='graph2', style={'height': '70vh'}),
